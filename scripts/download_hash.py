...
downloads = {
    ...
    "kubeadm": "https://dl_k8s_io-fwd.dockeria.ir/release/{version}/bin/linux/{arch}/kubeadm.sha256",
    "kubectl": "https://dl_k8s_io-fwd.dockeria.ir/release/{version}/bin/linux/{arch}/kubectl.sha256",
    "kubelet": "https://dl_k8s_io-fwd.dockeria.ir/release/{version}/bin/linux/{arch}/kubelet.sha256",
